 ...
 *
 * Ported verbatim from ~/bldesy-web/lib/capabilities.ts so the app and website
 * share one source of truth for:
 *   - the keys stored in the `required_capabilities` JSONB on jobs
 *   - the labels rendered in the post form and on the job detail screen
