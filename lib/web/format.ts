// AUTO-SYNCED from ~/bldesy-web/lib/format.ts by scripts/sync-web-libs.mjs — DO NOT EDIT HERE.
// Change the website original, then run: npm run sync:web

/**
 * Shared formatting utilities used across client and server components.
 */
