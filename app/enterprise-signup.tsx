...
/**
 * Enterprise (company) signup is handled on the website. This screen is a
 * thin hand-off: it opens the web registration in an in-app browser with the
...
export default function EnterpriseSignupScreen() {
  ...
  const open = useCallback(async () => {
    setBusy(true);
    try {
      await openWebOnboarding('enterprise');
    } finally {
      setBusy(false);
    }
  }, []);
  ...
  return (
    <AppShell title="List your company" showBack>
      <View style={styles.body}>
        ...
        <ThemedText style={[styles.bodyText, { color: c.textSecondary }]}>
          Listing your company — team, credentials and insurance — is quickest
          on our website. We&apos;ll take you there now, already signed in. When
          you&apos;re done, head back to the app.
        </ThemedText>
